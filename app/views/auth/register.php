...
<head>
    ...
    <title>Daftar Akun - Productivity App</title>
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <div class="min-h-screen flex bg-white">
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Sudah punya akun? <a href="<?= base_url('login') ?>" class="font-medium text-blue-600 hover:text-blue-500">Masuk di sini</a>
                    </p>
                </div>
                ...
                <div class="mt-8">
                    <form action="" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                ...
                                <button type="button" onclick="togglePass('password', 'eye1')" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    <svg id="eye1" class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                <input id="confirm_password" name="confirm_password" type="password" required 
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <button type="button" onclick="togglePass('confirm_password', 'eye2')" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    <svg id="eye2" class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    </svg>
                                </button>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6">
                            <a href="<?= base_url('auth/google') ?>" class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors">
        ...
        <div class="hidden lg:block relative w-0 flex-1">
            <img class="absolute inset-0 h-full w-full object-cover" src="https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80" alt="Background Registration">
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        Swal.fire({
            ...
            customClass: {
                popup: 'modern-alert animate__animated animate__headShake',
                title: 'modern-title',
                confirmButton: 'modern-confirm-btn bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-200 transition-all'
            },
